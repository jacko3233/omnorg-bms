...
export default function FabricationJobs() {
  ...
  // Filter jobs for fabrication department with useMemo optimization
  const fabricationJobs = useMemo(() => 
    jobs.filter(job => job.department === 'FABRICATION' || job.jobLes?.startsWith('LEF')), 
    [jobs]
  );
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="max-w-7xl mx-auto p-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-5xl font-bold text-gray-800 mb-2">FABRICATION DEPARTMENT</h1>
          <p className="text-xl text-gray-600">Manufacturing • Welding • Custom Steel Fabrication</p>
        </div>
        ...
        <div className="mb-8 flex flex-col md:flex-row gap-4 items-center justify-between">
          ...
          <Button 
            onClick={() => setLocation('/fabrication-jobs/new')} 
        ...
        {filteredJobs.length === 0 ? (
          <div className="text-center py-12">
            <div className="bg-white rounded-lg shadow-lg p-8 max-w-md mx-auto">
              ...
              <Button onClick={() => setLocation('/fabrication-jobs/new')} className="bg-red-600 hover:bg-red-700">
                <Plus className="w-4 h-4 mr-2" />
                Create First Job
              </Button>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredJobs.map((job) => (
              <Card 
                ...
                onClick={() => setLocation(`/fabrication/job/${job.id}`)}
              >
                  ...
                  <div className="flex justify-between items-center pt-3">
                    <div className="flex space-x-2">
                      ...
                      <Dialog>
                        ...
                        <DialogHeader>
                          <DialogTitle>Fabrication Job Details - {job.jobLes}</DialogTitle>
                        </DialogHeader>
                        {selectedJob && (
