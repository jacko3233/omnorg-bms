...
export default function NewFabricationJob() {
  ...
  const createJobMutation = useMutation({
    ...
    onSuccess: () => {
      toast({
        title: "Success",
        description: "Fabrication job created successfully!",
      });
      queryClient.invalidateQueries({ queryKey: ['/api/jobs'] });
      setLocation('/fabrication-jobs');
    },
    onError: (error: any) => {
      toast({
        title: "Error",
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const jobData: InsertJob = {
      ...
      jobType: 'Fabrication', // Set consistent job type
      department: 'FABRICATION', // Auto-assign department for job numbering
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      <div className="max-w-5xl mx-auto p-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-800 mb-2">Create New Fabrication Job</h1>
          <p className="text-gray-600">Enter job details for the fabrication services database</p>
        </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                    ...
                    <p className="text-sm text-blue-600">
                      Job number and Fabrication code will be automatically generated when this job is created.
                      <br />
                      <span className="font-medium">Job Type: Fabrication</span> → Job LES will start with "LEF"
                    </p>
                  </div>
