          ...
          <div className="bg-white rounded-lg shadow-lg p-12 text-center">
            <div className="mb-8">
              ...
              <div className="text-lg text-gray-600 space-y-4">
                <p>Your credit application has been successfully submitted.</p>
                <p className="font-semibold">We will review your application and be in touch with you shortly.</p>
            ...
            <div className="border-t border-gray-200 pt-6">
              <p className="text-sm text-gray-500">
                Application submitted for: <span className="font-medium">{formData.companyName}</span>
              </p>
            </div>
          </div>
        </div>
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="bg-red-600 text-white p-6">
        <div className="flex items-center justify-center max-w-7xl mx-auto">
          <div className="text-center">
            <div className="bg-white text-red-600 rounded-lg p-3 font-bold text-lg inline-block mb-2">
              CREDIT APPLICATION
            </div>
            <h1 className="text-2xl font-medium">Business Credit Application Form</h1>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto p-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-800 mb-2">APPLICATION FOR CREDIT ACCOUNT</h1>
          <p className="text-lg text-gray-600">Please complete all relevant fields</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="mb-8 p-6 bg-gray-50 rounded-lg">
            ...
            <div className="text-sm text-gray-600 space-y-2">
              ...
              <p>• We are GDPR compliant. We may share your information with credit reference agencies and other companies for use in credit decisions, for fraud prevention and to pursue debtors.</p>
            </div>
          </div>
          ...
          <div className="flex justify-center mt-8 pt-6 border-t border-gray-200">
            <Button
              ...
              className="bg-red-600 hover:bg-red-700 flex items-center space-x-2 text-lg px-8 py-3"
            >
              <Save className="w-5 h-5" />
              <span>{createClientMutation.isPending ? "Submitting Application..." : "Submit Credit Application"}</span>
            </Button>
          </div>
        </div>
      </div>
