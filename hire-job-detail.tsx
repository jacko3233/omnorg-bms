...
import { ArrowLeft, Calendar, User, DollarSign, FileText, Package, Phone, Mail, MapPin, Edit } from 'lucide-react';
import JobEditModal from '@/components/JobEditModal';
import type { Job, Client } from '@shared/schema';

export default function HireJobDetail() {
  const [, params] = useRoute('/hire/job/:id');
      ...
      <div className="min-h-screen bg-gray-100">
        <div className="flex items-center justify-center h-64">
          <div className="text-center">
            ...
            <Button onClick={() => setLocation('/hire')}>
              <ArrowLeft className="w-4 h-4 mr-2" />
              Back to Hire Department
            </Button>
          </div>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="max-w-7xl mx-auto p-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-600">Hire Department Job Information</p>
        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  <div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center text-sm text-gray-600">
                        ...
                        <span>{client.invoiceAddress || 'No address'}</span>
                      </div>
                    </div>
                  </div>
                  <div>
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center text-sm">
                        <User className="w-4 h-4 mr-2 text-gray-400" />
                        <span>{client.directorName || 'No contact name'}</span>
                      </div>
                      <div className="flex items-center text-sm">
                        <Phone className="w-4 h-4 mr-2 text-gray-400" />
                        <span>{client.telephone || 'No phone'}</span>
                      </div>
                      <div className="flex items-center text-sm">
                  ...
                  <div>
                    ...
                    <div className="space-y-2 text-sm">
                      <p><span className="font-medium">Employees:</span> {client.numberOfEmployees || 'Not specified'}</p>
                      <p><span className="font-medium">Years Trading:</span> {client.yearsTrading || 'Not specified'}</p>
                      <p><span className="font-medium">Credit Amount:</span> £{client.creditApplicationAmount ? Number(client.creditApplicationAmount).toLocaleString() : 'Not specified'}</p>
                    </div>
                  </div>
                </div>
              </CardContent>
