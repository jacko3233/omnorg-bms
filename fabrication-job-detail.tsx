...
export default function FabricationJobDetail() {
  const [, params] = useRoute('/fabrication/job/:id');
      ...
      <div className="min-h-screen bg-gray-100">
        <div className="flex items-center justify-center h-64">
          <div className="text-center">
            ...
            <Button onClick={() => setLocation('/fabrication-jobs')}>
              <ArrowLeft className="w-4 h-4 mr-2" />
              Back to Fabrication Department
            </Button>
          </div>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-gray-100">
        ...
        <div className="flex items-center justify-between max-w-7xl mx-auto">
          <div className="flex items-center space-x-4">
            ...
            >
              ...
              <span className="font-medium">Back to Fabrication</span>
            </Button>
      ...
      <div className="max-w-7xl mx-auto p-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-600">Fabrication Department Job Information</p>
        </div>
        ...
        <div className="mt-8 flex justify-center space-x-4">
          <Button 
            onClick={() => setLocation(`/fabrication/job/${job.id}/edit`)}
