...
import { ArrowLeft, Calendar, User, DollarSign, FileText, Phone, Mail, MapPin, Edit } from 'lucide-react';
import JobEditModal from '@/components/JobEditModal';
import type { Job, Client } from '@shared/schema';

export default function TestingJobDetail() {
  const [, params] = useRoute('/testing/job/:id');
      ...
      <div className="min-h-screen bg-gray-100">
        <div className="flex items-center justify-center h-64">
          <div className="text-center">
            ...
            <Button onClick={() => setLocation('/testing-jobs')}>
              <ArrowLeft className="w-4 h-4 mr-2" />
              Back to Testing Department
            </Button>
          </div>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-gray-100">
        ...
        <div className="flex items-center justify-between max-w-7xl mx-auto">
          <div className="flex items-center space-x-4">
            ...
            >
              ...
              <span className="font-medium">Back to Testing</span>
            </Button>
      ...
      <div className="max-w-7xl mx-auto p-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-600">Testing Department Job Information</p>
        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  <div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center text-sm text-gray-600">
                        ...
                        <span>{client.addressLine1 || 'No address'}</span>
                      </div>
                    </div>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <p><span className="font-medium">Credit Limit:</span> £{client.requestedCreditLimit?.toLocaleString() || '0'}</p>
                    </div>
                  </div>
                </div>
              </CardContent>
